...
class TestTransferToAccount:
    ...
    def test_check_history(self, driver):
        ...
        driver.find_element(*TestLocators.field_registration_login).send_keys('butarov_9@gmail.com')
        driver.find_element(*TestLocators.field_registration_password).send_keys('12q12q12q')

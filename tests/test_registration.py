...
class TestRegistration:
    name = 'Test'
    email = f"butarov_9_{random.randint(100, 999)}@gmail.com"
    ...
    def test_registration_successful_registration(self, driver):
        ...
        driver.find_element(*TestLocators.button_registration).click()
        WebDriverWait(driver, 3).until(expected_conditions.text_to_be_present_in_element(TestLocators.title_entry, "Вход"))
